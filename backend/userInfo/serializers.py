...
class userInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = userInfo
        fields = ['id','first_name', 'last_name', 'email', 'phone_number', 'age', 'gender', 'occupation', 'risk_level', 'state_living_in', 'relationship_status', 'budget_value', 'user_ID_id', 'user_assets_monthly_ID_id', 'user_liabilities_monthly_ID_id', 'user_monthly_expenses_ID_id', 'user_monthly_income_ID_id']
        depth = 1
